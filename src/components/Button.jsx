...
const Inner = () => (
    <>
        <div className='relative glow-before glow-after rounded-2xl inner-before group-hover:before:opacity-100 overflow-hidden'>
        <span className="flex items-center min-h-[60px] px-4 g4 rounded-2xl inner-before group-hover:before:opacity-100 overflow-hidden">
